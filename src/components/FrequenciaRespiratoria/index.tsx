...
import { LungSVGComponent } from 'src/icons';
...
const rows = [
    createData('Frequência', 42, 20, 30, 42, 20, 30, 42, 20, 30),
...
export default function FrequenciaRespiratoria() {
    ...
    return (
        <Accordions title="Frequência Respiratória" hasIcon={<LungSVGComponent />} >
            <TableContainer>
